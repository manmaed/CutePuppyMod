...
public class Achievements {
	...
	public static void Load() {
		...
		puppykiller = new Achievement("achievement.puppykiller", "puppykiller", 1, 1, CPMItems.redcore, null).func_75966_h().func_75971_g();
        killEnderPuppy = new Achievement("achievement.enderpuppy", "enderpuppy", 1, -1,CPMItems.endercore, Achievements.puppykiller).func_75971_g();
		...
		killedbosspuppy = new Achievement("achievement.killedbosspuppy", "killedbosspuppy", 2, 0, CPMItems.banhammer, Achievements.puppykiller).func_75971_g();
