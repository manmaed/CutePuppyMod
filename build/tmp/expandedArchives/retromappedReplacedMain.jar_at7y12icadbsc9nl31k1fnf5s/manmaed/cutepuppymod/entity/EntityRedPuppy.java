...
public class EntityRedPuppy extends EntityAnimal
{
	public EntityRedPuppy(World par1World)
	{
        super(par1World);
    ...
    public EntityRedPuppy spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new EntityRedPuppy(this.field_70170_p);
    }

    protected SoundEvent func_184639_G()
    {

        return this.field_70146_Z.nextInt(3) == 0 ? SoundEvents.field_187857_gE : SoundEvents.field_187871_gL;
    }
    /**
    ...
    protected void func_70628_a(boolean par1, int par2)
    {
        ...
        {
            this.func_145779_a(CPMItems.redcore, 1);
        }
    }
