...
public class RecipeHandler {
	...
	*/
		...
		GameRegistry.addRecipe(new ItemStack(CPMItems.redsword),
                ...
                " R ",
                " S ",
                'R', CPMItems.redcore, 'S', Items.field_151055_y);
        GameRegistry.addRecipe(new ItemStack(CPMItems.greensword),
                " R ",
                " R ",
                " S ",
                'R', CPMItems.greencore, 'S', Items.field_151055_y);
        GameRegistry.addRecipe(new ItemStack(CPMItems.bluesword),
                " R ",
                " R ",
                " S ",
                'R', CPMItems.bluecore, 'S', Items.field_151055_y);
        GameRegistry.addRecipe(new ItemStack(CPMItems.yellowsword),
                " R ",
                " R ",
                " S ",
                'R', CPMItems.yellowcore, 'S', Items.field_151055_y);
        GameRegistry.addRecipe(new ItemStack(CPMItems.purplesword),
                " R ",
                " R ",
                " S ",
                'R', CPMItems.purplecore, 'S', Items.field_151055_y);
        GameRegistry.addRecipe(new ItemStack(Items.field_151079_bi),
                "EEE",
                "EEE",
                "EEE",
