...
public class RenderHerobrine extends MobRenderer<EntityHerobrine, ModelPuppy<EntityHerobrine>> {
    private static final ResourceLocation normal = new ResourceLocation(Reference.id, "textures/entity/herobrine_normal.png");
    private static final ResourceLocation mad = new ResourceLocation(Reference.id, "textures/entity/herobrine_mad.png");
