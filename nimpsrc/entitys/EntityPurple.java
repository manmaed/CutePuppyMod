 ...
 */
public class EntityPurple /*extends TameableEntity*/ {

    /*protected EntityPurple(EntityType<? extends TameableEntity> type, World worldIn) {
        super(type, worldIn);
        this.setTamed(false);
    }
    ...
    *//**
    ...
    public AgeableEntity func_241840_a(ServerWorld world, AgeableEntity entity) {
        EntityPurple red = new EntityPurple(CPEntityTypes.PURPLE.get(), world);
