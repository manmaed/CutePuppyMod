...
public class ModelPuppy extends EntityModel {
  RendererModel head;
  RendererModel Nose;
  RendererModel Body;
  RendererModel LegFL;
  ...
  public ModelPuppy() {
    ...
    Nose = new RendererModel(this, 0, 26);
    ...
    LegFL = new RendererModel(this, 0, 20);
    ...
    LegFR = new RendererModel(this, 0, 20);
    ...
    LegBL = new RendererModel(this, 18, 20);
    ...
    LegBR = new RendererModel(this, 18, 20);
    ...
    Tail = new RendererModel(this, 8, 20);
    ...
    EarR = new RendererModel(this, 21, 0);
    ...
    EarL = new RendererModel(this, 15, 0);
    ...
    ThePinkThing = new RendererModel(this, 16, 10);
