 ...
 */
public class EntityYellow extends TamableAnimal {

    protected EntityYellow(EntityType<? extends TamableAnimal> entityType, Level level) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob mob) {
        EntityYellow entity = new EntityYellow((CPEntityTypes.YELLOW.get()), serverLevel);
