 ...
 */
public class EntityPurple extends TamableAnimal {

    protected EntityPurple(EntityType<? extends TamableAnimal> entityType, Level level) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob mob) {
        EntityPurple entity = new EntityPurple((CPEntityTypes.PURPLE.get()), serverLevel);
