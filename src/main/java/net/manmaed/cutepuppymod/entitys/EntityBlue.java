 ...
 */
public class EntityBlue extends TamableAnimal {

    protected EntityBlue(EntityType<? extends TamableAnimal> entityType, Level level) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob mob) {
        EntityBlue blue = new EntityBlue((CPEntityTypes.BLUE.get()), serverLevel);
        UUID uuid = this.getOwnerUUID();
        if (uuid != null) {
            blue.setOwnerUUID(uuid);
            blue.setTame(true);
        }
        return blue;
    }
