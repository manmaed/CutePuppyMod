 ...
 */
public class EntitySteve extends TameableEntity {

    protected EntitySteve(EntityType<? extends TameableEntity> type, World worldIn) {
        super(type, worldIn);
        this.setTamed(false);
    }
    ...
    public AgeableEntity func_241840_a(ServerWorld world, AgeableEntity entity) {
        EntitySteve red = new EntitySteve(CPEntityTypes.BLUE.get(), world);
