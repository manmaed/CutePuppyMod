...
public class CPEntityTypes {
    ...
    public static final RegistryObject<EntityType<EntityHerobrine>> HEROBRINE = ENTITY_TYPES.register(getName("herobrine"), () -> EntityType.Builder.of(EntityHerobrine::new, MobCategory.CREATURE).sized(width, height).build(getName("herobrine")));
