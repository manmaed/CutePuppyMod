...
public class Textures {
   ...
   // Model textures
   public static final ResourceLocation MODEL_GREEN_PUPPY = ResourceLocationHelper.getResourceLocation(MODEL_SHEET_LOCATION + "GreenPuppy.png");
   ...
   public static final ResourceLocation MODEL_HAZARD_PUPPY = ResourceLocationHelper.getResourceLocation(MODEL_SHEET_LOCATION + "HazardPuppy.png");
