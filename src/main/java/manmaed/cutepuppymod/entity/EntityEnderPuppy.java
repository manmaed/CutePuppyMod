...
public class EntityEnderPuppy extends EntityMob {
    ...
    private static final DataParameter<Boolean> SCREAMING = EntityDataManager.<Boolean>createKey(EntityEnderPuppy.class, DataSerializers.BOOLEAN);
    ...
    protected SoundEvent getAmbientSound()
    {
        ...
        return this.rand.nextInt(2) == 0 ? SoundEvents.ENTITY_WOLF_AMBIENT : SoundEvents.ENTITY_ENDERMEN_AMBIENT;
    }
    /**
