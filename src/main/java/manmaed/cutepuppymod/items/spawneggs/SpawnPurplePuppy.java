...
public class SpawnPurplePuppy extends Item {
	private static String name = "SpawnPurplePuppy";
	public static String getName() {

		return name;
	}
	public SpawnPurplePuppy(){
		super();
...
/*	public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer)
    {
            EntityNumiPuppy par1EntityNumiPuppy = new EntityNumiPuppy(world);
            world.spawnEntityInWorld(par1EntityNumiPuppy);
	...
	*/
	public boolean onItemUse(ItemStack item, EntityPlayer player, World world, int x, int y, int z, int side, float xOffset, float yOffset, float zOffSet)
	{
			...
			if (!world.isRemote)
			{
				EntityPurplePuppy ent = new EntityPurplePuppy(world); //change to whatever entity you're trying to spawn
