 ...
 */
public class EntityGreen extends TamableAnimal {

    protected EntityGreen(EntityType<? extends TamableAnimal> entityType, Level level) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob mob) {
        EntityGreen entity = new EntityGreen((CPEntityTypes.GREEN.get()), serverLevel);
